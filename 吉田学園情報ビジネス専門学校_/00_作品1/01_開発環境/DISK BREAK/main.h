...
#define BULLET_SIZEX (300.0f)//Xの長さ
#define BULLET_SIZEY (300.0f)//Yの長さ
...
#define BG_SKY_TEXTURE ("data/TEXTURE/bg100.png")	//弾のTEXTURE
#define BG_MOUNTAIN1_TEXTURE ("data/TEXTURE/bg101.png")	//弾のTEXTURE
#define BG_MOUNTAIN2_TEXTURE ("data/TEXTURE/bg102.png")	//弾のTEXTURE
#define ENEMY_TEXTURE ("data/TEXTURE/ピカチュウ.png")	//敵のTEXTURE
...
#define FADE_TEXTURE ("data/TEXTURE/フェード.png")	//ナンバーのテクスチャ
//プレイヤーマクロ

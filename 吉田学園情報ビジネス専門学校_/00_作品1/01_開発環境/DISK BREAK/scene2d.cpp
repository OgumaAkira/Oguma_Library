...
void CScene2D::Update(void)
{
	...
	//半径ｒの計算
	float fr = sqrtf((m_size.x / 2.0f) * m_size.x / 2.0f + (m_size.y / 2.0f) * m_size.y / 2.0f);
...
void CScene2D::SetTex(D3DXVECTOR2 tex, D3DXVECTOR2 tex2)
{
	...
	pVtx[1].tex = D3DXVECTOR2((float)tex2.x + 1.0f, tex.y + 0.0f);
	pVtx[2].tex = D3DXVECTOR2((float)tex.x + 0.0f, tex2.y + 1.0f);
	pVtx[3].tex = D3DXVECTOR2((float)tex2.x + 1.0f, tex2.y + 1.0f);

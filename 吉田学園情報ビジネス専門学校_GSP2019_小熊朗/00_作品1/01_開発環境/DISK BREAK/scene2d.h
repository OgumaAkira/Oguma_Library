...
public:
	...
	void BirdTexture(LPDIRECT3DTEXTURE9 pTexture);		//テクスチャの情報格納関数
	D3DXVECTOR3 GetPosition();							//位置取得関数
	D3DXVECTOR3 GetSize();								//大きさ取得関数
	D3DXVECTOR2	GetTex();								//テクスチャ取得関数
	D3DXCOLOR	GetColor();								//色取得関数

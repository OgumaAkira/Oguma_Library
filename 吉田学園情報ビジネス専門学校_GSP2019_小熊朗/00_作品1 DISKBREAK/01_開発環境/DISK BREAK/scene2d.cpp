...
HRESULT CScene2D::Init(void)
{
	...
	//色の設定
	pVtx[0].col = D3DXCOLOR(D3DCOLOR_RGBA(255, 255, 255, 255));//左上
	pVtx[1].col = D3DXCOLOR(D3DCOLOR_RGBA(255, 255, 255, 255));//右上
	pVtx[2].col = D3DXCOLOR(D3DCOLOR_RGBA(255, 255, 255, 255));//左下
	pVtx[3].col = D3DXCOLOR(D3DCOLOR_RGBA(255, 255, 255, 255));//右下

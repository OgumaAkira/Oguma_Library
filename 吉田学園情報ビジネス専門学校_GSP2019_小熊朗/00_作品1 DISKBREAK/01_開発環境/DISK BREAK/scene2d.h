...
public:
	...
	D3DXVECTOR3 GetPosition()						{ return D3DXVECTOR3(m_pos); }	//位置取得関数
	D3DXVECTOR3 GetSize()							{ return D3DXVECTOR3(m_size); }	//大きさ取得関数
	D3DXVECTOR2	GetTex()							{ return D3DXVECTOR2(m_tex); }	//テクスチャ取得関数
